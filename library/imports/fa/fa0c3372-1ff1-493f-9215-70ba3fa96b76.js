            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        after_pos = ECSUtil_1.default.getInstance().position_after_time(time, enemyEntity.transformComponent, enemyEntity.navComponent);
                        w_dst_pos_1 = shoot_enemy.parent.convertToWorldSpaceAR(after_pos);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        dst_pos = bulletBaseComponent.gameObject.parent.convertToNodeSpaceAR(w_dst_pos);
                        m = cc.moveBy(time, w_dst_pos.x - w_start_pos.x, w_dst_pos.y - w_start_pos.y - 30);
                        bomb_anim_1 = [];
                        i = 0;
                        _a.label = 1;
                    case 1:
