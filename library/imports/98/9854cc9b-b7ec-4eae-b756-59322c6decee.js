"use strict";
cc._RF.push(module, '9854cybt+xOrrdWWTIsbezu', 'GenMapPath');
// Scripts/Game/GenMapPath.ts
...
var GenMapPath = /** @class */ (function (_super) {
    __extends(GenMapPath, _super);
    function GenMapPath() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.anim_com = null;
        _this.graphics = null;
        _this.road_data_set = null;
        _this.is_debug = true;
        return _this;
    }
    GenMapPath.prototype.onLoad = function () {
        ...
        GameDataManager_1.default.getInstance().set_map_road_set(this.road_data_set);
    };
    GenMapPath.prototype.start = function () {
        /*
        // test()
    ...
    GenMapPath.prototype.get_road_set = function () {
        return this.road_data_set;
    };
    GenMapPath.prototype.gen_path_data = function (road_data) {
        var ctrl1 = null;
    ...
    GenMapPath.prototype.bezier_length = function (start_point, ctrl1, ctrl2, end_point) {
    ...
    GenMapPath = __decorate([
        ccclass
    ], GenMapPath);
    return GenMapPath;
}(cc.Component));
exports.default = GenMapPath;
